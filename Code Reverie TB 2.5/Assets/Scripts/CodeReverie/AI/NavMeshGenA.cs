...
namespace CodeReverie
{
...

    {
        ...
        //     //     attachParent.transform.localPosition = new Vector3(0,
        //     //         0 + terrain.transform.localPosition.y, 0);
        //     // }
        // }
        //
        // [Button("Dostroy")]
        // void DestroyTempObject()
        // {
        //     GameObject attachParent;
        //     Transform childA = terrain.transform.Find("Delete me");
        //     
        ...
        public void GenerateTempParentObject()
        {
            GameObject attachParent;
            // Transform childA = terrain.transform.Find("Delete me");
        ...
        IEnumerator GenMeshes()
        {
            ...
            if (includeTrees)
            {
                ...
                foreach (TreeInstance inst in instances)
                {
                    ...
                    GameObject tree = Instantiate(prototype.prefab);
        ...
        void destroyChildren(Transform attachParent)
        {
            ...
            while (attachParent.childCount > 0)
                DestroyImmediate(attachParent.GetChild(0).gameObject);
