...
{
    public class ExponentialExperienceCalculator 
    {
        //Optimized values: a = 11.2512759999728, b = 1.2894724999974
        ...
        private void Start()
        {
            Initialize(1, 4, 10, 334);
        }

        public ExponentialExperienceCalculator(double a, double b, int startingXP)
        {
            this.a = a;
            this.b = b;
        ...
        public void Initialize(int startingLevel, int startingXP, int desiredLevel, int desiredXP)
        {
            ...
            {
                var expXP = new ExponentialExperienceCalculator(a, b, startingXP);
            ...
            var finalExpXP = new ExponentialExperienceCalculator(a, b, startingXP);
