...
namespace CodeReverie
{
    ...
    public class AreaManagerConfig : SerializedScriptableObject
    {
        ...
        //public Dictionary<string, CharacterUnitAreaStateManager> characterUnitAreaStateManagers = new Dictionary<string, CharacterUnitAreaStateManager>();
        public List<CharacterUnitAreaStateManager> characterUnitAreaStateManagers =
